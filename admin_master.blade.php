...
<html>
    <head>
        ...
        <title>
            @yield('head_master.title')
        </title>
        <meta name="csrf-token" content="{{ csrf_token() }}">
        <meta content='width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no' name='viewport'>
        <!-- bootstrap 3.0.2 -->
        <script src="{{asset('assets/js/AdminLTE/jquery-1.7.2.js')}}" type="text/javascript"></script>
        <script src="{{asset('assets/js/AdminLTE/jquery.validate.min.js')}}" type="text/javascript"></script>
        <script src="{{asset('assets/js/AdminLTE/messages_vi.js')}}" type="text/javascript"></script> 
        <script src="{{asset('assets/js/AdminLTE/ManagerAll.js')}}" type="text/javascript"></script> 
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="left-side sidebar-offcanvas">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li>
                            <a href="{{action('AdminController@widgets')}}">
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="{{action('AdminController@formGeneral')}}"><i class="fa fa-angle-double-right"></i> Quản lý Sản Phẩm</a></li>
                                <li><a href="{{action('AdminController@formAdvance')}}"><i class="fa fa-angle-double-right"></i> Advanced Elements</a></li>
                                <li><a href="{{action('AdminController@formEditor')}}"><i class="fa fa-angle-double-right"></i> Editors</a></li>
                            </ul>
                        </li>
                        <li class="treeview">
                            <a href="#">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="{{action('AdminController@tableSimple')}}"><i class="fa fa-angle-double-right"></i> Simple tables</a></li>
                                <li><a href="{{action('AdminController@tableData')}}"><i class="fa fa-angle-double-right"></i> Data tables</a></li>
                            </ul>
                        </li>
                        <li>
                            <a href="{{action('AdminController@mail')}}">
            ...
            <aside class="right-side">
                ...
                <section class="content">
                    @yield('body_master.content')
                </section>
            </aside><!-- /.right-side -->
        </div><!-- ./wrapper -->

        @yield('body_master.js')
